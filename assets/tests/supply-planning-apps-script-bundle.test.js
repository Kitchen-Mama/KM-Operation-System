...
(function () {
  ...
  ok(ctx.KMRDV2P && ctx.KMRDV2P.VERSION === 'kmrdv2p-fa3c-r2b3-1' && ctx.KMRDV2P.RECOMMENDATION_TYPE === 'MONTHLY_ORDER' && typeof ctx.KMRDV2P.generateMonthlyFlat === 'function' && typeof ctx.KMRDV2P.applyFlat === 'function' && typeof ctx.KMRDV2P.editMonthlyFlat === 'function' && typeof ctx.KMRDV2P.submitMonthlyFlat === 'function' && typeof ctx.KMRDV2P.flatReadbackDto === 'function' && ctx.KMRDV2P.v2ExpectedHeaderCount() === 53, 'C: KMRDV2P MONTHLY_ORDER flat persistence + edit/submit shape adapter available in bundle (F1-7N-FA-3C-R2b-3; cutover-gated, default off)');
