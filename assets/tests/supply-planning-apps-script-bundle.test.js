...
(function () {
  ...
  eq(b1.manifest.length, 27, 'A: manifest lists all 27 canonical modules');
...
(function () {
  ...
  eq(ctx.KM_BUNDLE_INFO.modules.length, 27, 'C: KM_BUNDLE_INFO manifest present in runtime');
})();
