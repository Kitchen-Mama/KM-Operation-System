...
(function () {
  ...
  eq(b1.manifest.length, 44, 'A: manifest lists all 44 canonical modules (incl. KMREC + KMREX + KMAR + KMFC + F1-7N weekly KMWSA/KMWIA/KMWRD/KMWRT)');
...
(function () {
  ...
  eq(ctx.KM_BUNDLE_INFO.modules.length, 44, 'C: KM_BUNDLE_INFO manifest present in runtime (44 modules incl. KMREX + KMAR + KMFC + F1-7N weekly KMWSA/KMWIA/KMWRD/KMWRT)');
})();
