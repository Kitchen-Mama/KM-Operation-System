...
(function () {
  ...
  eq(b1.manifest.length, 25, 'A: manifest lists all 25 canonical modules');
...
(function () {
  ...
  eq(ctx.KM_BUNDLE_INFO.modules.length, 25, 'C: KM_BUNDLE_INFO manifest present in runtime');
})();
