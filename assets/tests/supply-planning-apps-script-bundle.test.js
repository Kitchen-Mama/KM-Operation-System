...
(function () {
  ...
  eq(b1.manifest.length, 49, 'A: manifest lists all 49 canonical modules (incl. KMREC + KMREX + KMAR + KMFC + F1-7N weekly KMWSA/KMWIA/KMWRD/KMWRT/KMWRB/KMWHA + F1-7N-FA-3B3a KMOOP/KMOTA/KMOOR)');
...
(function () {
  ...
  eq(ctx.KM_BUNDLE_INFO.modules.length, 49, 'C: KM_BUNDLE_INFO manifest present in runtime (49 modules incl. KMREX + KMAR + KMFC + F1-7N weekly KMWSA/KMWIA/KMWRD/KMWRT/KMWRB/KMWHA + FA-3B3a KMOOP/KMOTA/KMOOR)');
})();
