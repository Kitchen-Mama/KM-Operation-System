...
(function () {
  ...
  eq(b1.manifest.length, 38, 'A: manifest lists all 38 canonical modules (incl. KMREC + KMREX + F1-4B-FM7-R2B allocation-runtime / KMAR)');
...
(function () {
  ...
  eq(ctx.KM_BUNDLE_INFO.modules.length, 38, 'C: KM_BUNDLE_INFO manifest present in runtime (38 modules incl. KMREX + KMAR)');
})();
