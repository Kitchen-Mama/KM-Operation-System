...
(function () {
  ...
  eq(b1.manifest.length, 35, 'A: manifest lists all 35 canonical modules');
...
(function () {
  ...
  eq(ctx.KM_BUNDLE_INFO.modules.length, 35, 'C: KM_BUNDLE_INFO manifest present in runtime');
})();
