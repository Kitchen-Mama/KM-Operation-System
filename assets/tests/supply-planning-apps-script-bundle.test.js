...
(function () {
  ...
  eq(b1.manifest.length, 26, 'A: manifest lists all 26 canonical modules');
...
(function () {
  ...
  eq(ctx.KM_BUNDLE_INFO.modules.length, 26, 'C: KM_BUNDLE_INFO manifest present in runtime');
})();
