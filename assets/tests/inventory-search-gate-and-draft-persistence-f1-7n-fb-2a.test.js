...
ok(/_irSaveAcknowledged_\(hres\)/.test(flush) && /PERSISTENCE_NOT_ACKNOWLEDGED/.test(flush),
  'D7. the save flow requires that ack and treats an unacknowledged response as a FAILED save');
