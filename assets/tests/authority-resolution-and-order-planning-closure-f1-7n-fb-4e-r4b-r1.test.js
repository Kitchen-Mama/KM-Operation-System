...
ok(/HOUSE_COUNTRY_ZH/.test(GEO), '15.1 the map house-display level survives');
ok(/CN: '\\u4e2d\\u570b'/.test(GEO) || /CN: '中國'/.test(GEO), '15.2 CN renders as 中國');
ok(/TW: '\\u53f0\\u7063'/.test(GEO) || /TW: '台灣'/.test(GEO), '15.3 TW renders as 台灣');
