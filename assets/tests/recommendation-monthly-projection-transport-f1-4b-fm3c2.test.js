...
ok(cM.getSheetByName === 21 && cM.write === 0, 'O request count = 17 targeted reads (13 canonical + R3 daily/weekly sales + R3a campaigns); ZERO writes — projection adds no write');
...
ok(cW.getSheetByName === 21 && cW.write === 0, 'G4 one targeted read (17 canonical tables) for the 2-warehouse fanout; zero writes');
