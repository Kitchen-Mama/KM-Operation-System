...
ok(H.bundleInfo && H.bundleInfo.modules.length === 52 && H.bundleInfo.modules.some(function (m) { return m.module === 'supply-planning-horizon-projection'; }), 'KM_BUNDLE_INFO = 52 modules incl. horizon-projection (F1-7N weekly + FA-3B3a KMOOP/KMOTA/KMOOR + FA-3B3b KMFSR + FA-3C KMRDV2 + KMRDV2P added)');
