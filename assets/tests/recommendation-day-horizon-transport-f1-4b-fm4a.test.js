...
ok(H.bundleInfo && H.bundleInfo.modules.length === 53 && H.bundleInfo.modules.some(function (m) { return m.module === 'supply-planning-horizon-projection'; }), 'KM_BUNDLE_INFO = 53 modules incl. horizon-projection (F1-7N weekly + FA-3B3a KMOOP/KMOTA/KMOOR + FA-3B3b KMFSR + FA-3C KMRDV2 + KMRDV2P + R6F2 KMWRR added)');
...
ok(cM.getSheetByName === 21 && cM.write === 0, 'M7 one targeted read (17 tables incl. fc_target_rules + FM5-R4UI-R3 daily/weekly sales); ZERO writes — horizons add no write');
