...
ok(H.bundleInfo && H.bundleInfo.modules.length === 46 && H.bundleInfo.modules.some(function (m) { return m.module === 'supply-planning-horizon-projection'; }), 'KM_BUNDLE_INFO = 46 modules incl. horizon-projection (F1-7N weekly modules added)');
