...
ok(cM.getSheetByName === 12, 'D8 targeted read ONCE (12 canonical tables; no per-SKU/per-destination re-open)');
...
ok(cW.getSheetByName === 12 && cW.write === 0, 'E6 ONE targeted read for 2-destination fanout (no per-destination re-open); zero writes');
