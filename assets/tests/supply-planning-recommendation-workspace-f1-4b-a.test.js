...
ok(cM.getSheetByName === 21, 'D8 targeted read ONCE (17 canonical tables incl. FM5-R4UI-R3 daily/weekly sales; no per-SKU/per-destination re-open)');
...
ok(cW.getSheetByName === 21 && cW.write === 0, 'E6 ONE targeted read (17 canonical tables) for 2-destination fanout (no per-destination re-open); zero writes');
