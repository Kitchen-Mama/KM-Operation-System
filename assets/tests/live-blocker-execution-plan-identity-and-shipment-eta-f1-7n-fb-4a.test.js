...
ok(!!_rosExpected, '19. the manifest declares an expected build for the Send owner (' + _rosExpected + ')');
eq(rosBuild, _rosExpected, '19. and the Send owner declares exactly that, so a partial sync is visible');
