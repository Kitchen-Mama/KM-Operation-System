...
// ------------------------------------------------------------------------------------------------------------
var SYS_BUILD_VERSION_ = 'F1-7N-FC-1B-E3-R1';
// ------------------------------------------------------------------------------------------------------------
...
var SYS_MODULE_BUILD_STAMPS_ = [
  { file: '63_api_v1_system_health.gs', symbol: 'SYS_BUILD_VERSION_', expected: 'F1-7N-FC-1B-E3-R1', owns: 'deployment identity + health + transport contract + the effective feature-flag report' },
  ...
  { file: '61_api_v1_weekly_ai_plan.gs', symbol: 'WAP_BUILD_VERSION_', expected: 'F1-7N-FC-1B-E3-R1', owns: 'weekly AI Plan harvest + canonical readiness refusal + K2 generation' },
