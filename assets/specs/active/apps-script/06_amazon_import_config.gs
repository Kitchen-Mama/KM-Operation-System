...
//   - Amazon Daily Sales is read from BigQuery (rolling 4-day window)
// Phase 3A additions:
...
//   - Daily Sales BigQuery fallback: if the rolling 4-day window is empty, fall back to
//     latest-available data PER country/marketplace/channel/sku group (own 4-day window).
...
var IMPORT_CONFIGS = [
  ...
  // 4 — amazon_daily_sales_snapshot (BigQuery, rolling 4-day window)
  {
    sourceType: 'bigquery',
