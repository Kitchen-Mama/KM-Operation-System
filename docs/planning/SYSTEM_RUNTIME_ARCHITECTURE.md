...
> - **Last Reviewed:** 2026-08-03 (Batch B B-5 Decision Round — Recommendation→Request writer boundary + line/source grain RESOLVED, decision only, owner RO&PO §3.9; §7B writer rows annotated. Prior: Round 11A Calculation Pure Runtime closure sync; §7B added).
