...
**FA-3B4 status:** `FA_3B4_IMPLEMENTED = NO`; `FACTORY_REALLOCATION_PERSISTENCE_READY = NO` (blocked on `D-B4-GAP-TRANSPORT-SCHEMA`). No runtime code, no Apps Script, no schema changed in this audit.
